...
public class InstructionPutfield extends AbstractInstruction {
    ...
    protected InstructionPutfield(byte[] code, int index, ConstantPool pool) throws IllegalArgumentException,
