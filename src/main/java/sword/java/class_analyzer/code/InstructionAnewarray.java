...
public class InstructionAnewarray extends AbstractInstruction {
    ...
    protected InstructionAnewarray(byte[] code, int index, ConstantPool pool) throws IllegalArgumentException,
