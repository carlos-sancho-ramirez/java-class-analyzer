...
public class InstructionDstore extends AbstractOneByteIndexedInstruction {

    public InstructionDstore(byte[] code, int index, ConstantPool pool,
    ...
    public String disassemble() {
        return "dstore " + mLocalVariableIndex;
    }
}
